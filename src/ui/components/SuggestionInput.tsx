...
export const SuggestionInput: FC<Omit<HTMLProps<HTMLInputElement>, "ref"> & {
    ...
    return <div className="relative w-full" ref={wrapperRef}>
        ...
        {!!matching.length && shown &&
            <div className="w-full cursor-pointer absolute border-1 border-gray-400 rounded-md shadow-md">
                {matching.map(e => <div key={JSON.stringify(e.searchable)} className="item p-2 bg-white"
                                        onClick={() => {
